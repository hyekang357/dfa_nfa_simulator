...
//        GC.strokeText("BR", 900, 477);
    ...
    public void drawTest2() {
        ...
        // Create objects
     // Create objects
        Arrow sa0 = new Arrow(false, 100, 258, 196, 258, "start"); //start  horizontal
        ...
        State q1 = new State(true, 408, 208, 100, "q1");
        State q2 = new State(false, 408, 8, 100, "q2");
        State q3 = new State(false, 608, 208, 100, "q3");
        State q4 = new State(true, 608, 8, 100, "q4");
    ...
    public void drawTest3() {
        ...
        Arrow aa2 = new Arrow(true, 408, 208, "1");
        Arrow sa3 = new Arrow(false, 516, 258, 597, 258, "0");
        Arrow ta2 = new Arrow(true, 608, 208, "0,1");
